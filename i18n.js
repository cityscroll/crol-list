...
const STRINGS = {
  en: {
    ...
    about_p_content: "This site's copy — the explanations, headings, and pages like this one — is drafted with an AI assistant (Claude) and reviewed by a human editor before it's published. The data itself is not AI-generated: every notice, dollar figure, and date comes straight from NYC Open Data, unedited.",
  ...
  es: {
    ...
    about_p_content: "El texto de este sitio — las explicaciones, los títulos y páginas como esta — se redacta con un asistente de IA (Claude) y lo revisa un editor humano antes de publicarlo. Los datos en sí no son generados por IA: cada aviso, cifra y fecha proviene directamente de NYC Open Data, sin editar.",
